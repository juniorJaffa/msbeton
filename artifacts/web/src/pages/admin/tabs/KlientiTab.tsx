                        ...
                        <div className="border border-gray-200 bg-white divide-y divide-gray-100">
                          ...
                          <label className="flex items-center gap-3 px-3 py-2.5 cursor-pointer hover:bg-gray-50 select-none">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="text-[11px] text-gray-400">Zaškrtni ak klient nechce potvrdzovací email (napr. interný účet). Platí pre košík aj SMS objednávky — bez ohľadu na kanál príde max. 1 email. Adresy @msbeton.sk sa preskakujú automaticky.</div>
                            </div>
                          </label>
