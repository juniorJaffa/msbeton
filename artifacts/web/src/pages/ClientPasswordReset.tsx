  ...
  if (!token) {
    return (
      <>
        ...
        <Navbar />
        <main className="min-h-screen concrete-navy pt-20 pb-16 flex items-center justify-center">
          <div className="bg-white rounded-xl shadow-2xl max-w-sm w-full overflow-hidden text-center">
            <div className="py-6 text-center" style={{ background: "#001D3D" }}>
              <p className="font-black text-2xl tracking-widest" style={{ color: "#EDC531" }}>MS-BETON</p>
              <p className="text-xs mt-1" style={{ color: "rgba(255,255,255,0.5)" }}>Kalkulačka betónu</p>
            </div>
            <div className="p-8">
