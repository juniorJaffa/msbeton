...
export function VersionChecker() {
  ...
  return (
    <div className="fixed bottom-20 sm:bottom-4 left-1/2 -translate-x-1/2 z-50 max-w-xs w-[calc(100%-2rem)] bg-navy border border-primary/40 rounded-xl shadow-2xl px-4 py-3 flex items-center gap-3 text-white animate-in slide-in-from-bottom-4">
